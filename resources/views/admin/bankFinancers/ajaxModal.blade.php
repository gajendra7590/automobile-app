        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="form-group col-md-5">
                    ...
                    <input type='text' class="form-control" placeholder="Bank Branch Code" name="bank_branch_code"
                        value="{{ isset($data) && $data->bank_branch_code ? $data->bank_branch_code : '' }}" />
                </div>
                <div class="form-group col-md-3">
                    <label>Bank Contact Number</label>
                    <input type='text' class="form-control" placeholder="Bank Contact Number"
                        name="bank_contact_number"
                        value="{{ isset($data) && $data->bank_contact_number ? $data->bank_contact_number : '' }}" />
                </div>
                <div class="form-group col-md-4">
                    <label>Bank Email Address</label>
                    <input type='email' class="form-control" placeholder="Bank Email Address"
            ...
            <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <input type='text' class="form-control" placeholder="Bank Manager Name" name="bank_manager_name"
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type='email' class="form-control" placeholder="Bank Manager Email"
                        name="bank_manager_email"
            ...
            <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <input type='text' class="form-control" placeholder="Bank Financer Name"
                        name="bank_financer_name"
                        value="{{ isset($data) && $data->bank_financer_name ? $data->bank_financer_name : '' }}" />
                </div>
                <div class="form-group col-md-4">
                    <label>Bank Financer Contact</label>
                    <input type='text' class="form-control" placeholder="Bank Financer Contact"
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type='email' class="form-control" placeholder="Bank Financer Email"
                        name="bank_financer_email"
                        value="{{ isset($data) && $data->bank_financer_email ? $data->bank_financer_email : '' }}" />
                </div>
                <div class="form-group col-md-4">
                    <label>Bank Financer Address</label>
                    <input type='text' class="form-control" placeholder="Bank Financer Address"
                        name="bank_financer_address"
