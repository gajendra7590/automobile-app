<table class="table table-bordered">
    ...
    <tr>
        <th width="20%">ALTERNATE MOBILE NUMBER</th>
        <td width="20%">
    ...
    <tr>
        ...
        <td width="10%">
            <a class="btn btn-primary updateFormInfo" data-field_name="witness_person_name"
                data-input_type="input">SAVE</a>
        </td>
        ...
        <td width="10%">
            <a class="btn btn-primary updateFormInfo" data-field_name="witness_person_phone"
                data-input_type="input">SAVE</a>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td width="20%">
            <input type="date" class="form-control" placeholder="" name="sale_date"
                value="{{ isset($data->sale_date) ? $data->sale_date : 0.0 }}" readonly />
        </td>
        <td width="10%">
            ---
        </td>
