            ...
            <td style="text-align: left;border: 1px solid;width:100%; height: 2rem; " colspan="2">
                <table style="width:100%;border-collapse: collapse;">
                    ...
                    <tr>
                        <td
                            style="border-right: 1px solid;width:20%;text-align: center; height: 2rem;font-weight:bold;font-size:14px;">
                            {{ isset($data->paid_source) && $data->paid_source ? $data->paid_source : '' }}
                        </td>
                        <td
                            style="border-right: 1px solid;width:20%;text-align: center; height: 2rem;font-weight:bold;font-size:14px;">
                            {{ isset($data->payment_name) && $data->payment_name ? $data->payment_name : '' }}
                        </td>
                        <td style="text-align: center; height: 2rem; border-right: 1px solid;font-size:14px;">
                            {{ isset($data->paid_note) && $data->paid_note ? $data->paid_note : '' }}
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table style="width:100%;border-collapse: collapse;">
                    <tr style="border-bottom: 1px solid;">
                        ...
                        <td
                            ...
                            {{ isset($data->debit_amount) && $data->debit_amount ? $data->debit_amount : '' }}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td
                            ...
                            {{ isset($data->debit_amount) && $data->debit_amount ? number2WordConvert($data->debit_amount) : '' }}
                        </td>
                        <td style="text-align: center; height: 2rem;  padding-left: 0.5rem;"></td>
                    </tr>
