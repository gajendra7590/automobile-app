            ...
            return DataTables::of($data)
                ...
                ->addColumn('active_status', function ($row) {
                    if ($row->active_status == '1') {
                        return "<label class='switch'><input type='checkbox' value='$row->id' data-type='gstRtoRate' class='active_status' checked><span class='slider round'></span></label>";
                    } else {
                        return "<label class='switch'><input type='checkbox' value='$row->id' data-type='gstRtoRate' class='active_status'><span class='slider round'></span></label>";
                    }
                })
