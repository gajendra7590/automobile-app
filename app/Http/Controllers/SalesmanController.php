...
class SalesmanController extends Controller
{
    ...
    public function getActions($id)
    {
        ...
        $action .= '<a href="' . route('salesmans.edit', ['salesman' => $id]) . '" class="btn btn-sm btn-warning ajaxModalPopup" data-modal_title="Update Agent" data-modal_size="modal-lg"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>';
