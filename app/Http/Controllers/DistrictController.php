...
class DistrictController extends Controller
{
    ...
    public function getActions($row)
    {
        ...
        $action .= '<a href="' . route('districts.edit', ['district' => $row->id]) . '" class="btn btn-sm btn-primary ajaxModalPopup" data-modal_size="modal-lg" data-modal_title="UPDATE DISTRICT"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>';
