...
class RtoRegistrationController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $validator = Validator::make($postData, [
                ...
                'contact_mobile_number' => 'required|numeric|digits:10',
    ...
    public function getActions($id)
    {
        ...
        $action .= '<li><a href="' . route('rtoRegistration.show', ['rtoRegistration' => $id]) . '" class="ajaxModalPopup"  data-modal_size="modal-lg" data-modal_title="VIEW REGISTRATION DATA" data-title="View">VIEW DETAIL</a></li>';
        $action .= '<li><a href="' . route('rtoRegistration.edit', ['rtoRegistration' => $id]) . '" class="ajaxModalPopup" data-modal_title="UPDATE REGISTRATION DATA" data-title="Edit" data-modal_size="modal-lg">UPDATE</a></li>';
        $action  .= '</ul>';
        $action  .= '</div>';
        return $action;
    }
